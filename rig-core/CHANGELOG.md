...
## [0.11.1](https://github.com/getong/rig/compare/rig-core-v0.11.0...rig-core-v0.11.1) - 2025-04-10

### Added

- impl From<mcp_core::types::Tool> for ToolDefinition ([#385](https://github.com/getong/rig/pull/385))
- AWS Bedrock provider ([#318](https://github.com/getong/rig/pull/318))

### Fixed

- gemini embeddings does not work for multiple documents ([#386](https://github.com/getong/rig/pull/386))
- deserialization error due to serde rename of tool result ([#374](https://github.com/getong/rig/pull/374))

### Other

- Updated broken link xaiAPI in `completion.rs` ([#384](https://github.com/getong/rig/pull/384))
- Fix Clippy warnings for doc indentation and Error::other usage ([#364](https://github.com/getong/rig/pull/364))
