...
## [0.11.0](https://github.com/getong/rig/compare/rig-core-v0.10.0...rig-core-v0.11.0) - 2025-03-26

### Added

- Add audio generation to all providers ([#359](https://github.com/getong/rig/pull/359))
- Add image generation to all providers that support it ([#357](https://github.com/getong/rig/pull/357))
...
- added mcp_tool + Example ([#335](https://github.com/getong/rig/pull/335))
