...
## [0.33.1](https://github.com/getong/rig/compare/rig-core-v0.33.0...rig-core-v0.33.1) - 2026-03-26

### Added

- add grok xAI TTS ([#1530](https://github.com/getong/rig/pull/1530))

### Fixed

- skip serializing encrypted_content when None ([#1534](https://github.com/getong/rig/pull/1534))

### Other

- *(gemini)* Make `prompt_token_count` optional in gemini response ([#1548](https://github.com/getong/rig/pull/1548))
