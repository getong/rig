...
## [Unreleased]
## [0.40.0](https://github.com/getong/rig/compare/v0.39.0...v0.40.0) - 2026-07-07
...
- *(postgres)* update sqlx and pgvector ([#1992](https://github.com/getong/rig/pull/1992)) (by @gold-silver-copper)
...
- *(gemini)* live cassette hook-system stress suite ([#2013](https://github.com/getong/rig/pull/2013)) (by @gold-silver-copper)
...
- Gate Gemini image cassette tests on image feature ([#2007](https://github.com/getong/rig/pull/2007)) (by @gold-silver-copper) - #2007
- Add OpenRouter agent tool cassette regressions ([#2006](https://github.com/getong/rig/pull/2006)) (by @gold-silver-copper) - #2006
- Add ChatGPT Codex cassette regression suite ([#2005](https://github.com/getong/rig/pull/2005)) (by @gold-silver-copper) - #2005
- *(gemini)* production-grade generateContent cassette suite ([#2004](https://github.com/getong/rig/pull/2004)) (by @gold-silver-copper)
- *(anthropic)* production-grade Messages API cassette suite ([#2003](https://github.com/getong/rig/pull/2003)) (by @gold-silver-copper)
...
- *(deps)* bump assert_fs from 1.1.3 to 1.1.4 ([#1933](https://github.com/getong/rig/pull/1933)) (by @dependabot[bot])
- *(deps)* bump trybuild from 1.0.116 to 1.0.117 ([#1935](https://github.com/getong/rig/pull/1935)) (by @dependabot[bot])
- *(deps)* bump chrono from 0.4.44 to 0.4.45 ([#1934](https://github.com/getong/rig/pull/1934)) (by @dependabot[bot])
- *(deps)* bump uuid from 1.23.3 to 1.23.4 ([#1975](https://github.com/getong/rig/pull/1975)) (by @dependabot[bot])
- *(deps)* bump scylla from 1.6.0 to 1.7.0 ([#1932](https://github.com/getong/rig/pull/1932)) (by @dependabot[bot])
- *(anthropic)* add null citation streaming cassette ([#1978](https://github.com/getong/rig/pull/1978)) (by @gold-silver-copper)
- update agent and contribution guidance ([#1974](https://github.com/getong/rig/pull/1974)) (by @gold-silver-copper) - #1974
...
- run doctests and stop rig-sqlite opting out of them ([#1939](https://github.com/getong/rig/pull/1939)) (by @gold-silver-copper) - #1939
- *(rig-core)* replace nanoid with fastrand for internal IDs ([#1938](https://github.com/getong/rig/pull/1938)) (by @gold-silver-copper)
- *(examples)* migrate to a package-per-example layout ([#1937](https://github.com/getong/rig/pull/1937)) (by @gold-silver-copper)
- add Archestra to "Who is using Rig?" section ([#1925](https://github.com/getong/rig/pull/1925)) (by @arsenyinfo) - #1925
